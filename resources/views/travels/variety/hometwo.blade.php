<!DOCTYPE html>
 <html lang="zxx">
 <head>
<!-- Original URL: https://duruthemes.com/demo/html/travol/multipage-slider/index3.html
 ...
 <body><div style="z-index: 9999; position: fixed; width: 100%; border: 0px; padding: 5px; margin: 0px; background-color: transparent;  font-size: 12pt; font-family: sans-serif;" id="web2disk_nag" onclick="javascript: document.getElementById('web2disk_nag').style.display = 'none';">
     ...
     <header class="header slider-fade">
         <div class="owl-carousel owl-theme">
             ...
             <div class="text-center item bg-img" data-overlay-dark="4" data-background="img/slider/1.jpg">
             ...
             <div class="text-center item bg-img" data-overlay-dark="4" data-background="img/slider/2.jpg">
                 <div class="v-middle caption">
                     <div class="container">
                         <div class="row">
                             <div class="col-md-10 offset-md-1">
             ...
             <div class="text-center item bg-img" data-overlay-dark="4" data-background="img/slider/3.jpg">
                 <div class="v-middle caption">
                     <div class="container">
                         <div class="row">
                             <div class="col-md-10 offset-md-1">
                 ...
                 <div class="col-md-12">
                     <div class="owl-carousel owl-theme">
                         ...
                         <div class="item">
                             ...
                             <span class="category"><a href="#0">7 Tours </a></span>
                             <div class="con">
                         ...
                         <div class="item">
                             ...
                             <span class="category"><a href="#0">15% OFF </a></span>
                             <div class="con">
                         ...
                         <div class="item">
                             ...
                             <span class="category"><a href="tours2.html">7 Tours </a></span>
                             <div class="con">
