<!DOCTYPE html>
 <html lang="zxx">
 <head>
<!-- Original URL: https://duruthemes.com/demo/html/travol/multipage-slider/tours3.html
Date Downloaded: 5/20/2023 9:54:49 AM !-->
         ...
         <div class="container">
             ...
             <div class="collapse navbar-collapse" id="navbar">
                 <ul class="navbar-nav ms-auto">
                     ...
                     <li class="nav-item dropdown">  <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Tours  <i class="ti-angle-down"></i></a>
                         <ul class="dropdown-menu">
                             ...
                             <li><a href="tours3.html" class="dropdown-item active"><span>Tours 3 </span></a></li>
                         </ul>
                     </li>
             ...
             <div class="row">
                 ...
                 <div class="col-md-8">
                     <div class="row">
                             ...
                             <div class="square-flip">
                                 ...
                                 <div class="square2">
                                     <div class="square-container2">
                                         <h4>Rome, Italy </h4>
                                         <h6>$1.500 / per person </h6>
                                         <p>Travel non lorem ac ____ susce bibendum nulla facilisi. ________ nunc voluat miss conse _______ amet vestibulum. </p>
                         ...
                         <div class="col-md-6">
                             <div class="square-flip">
                                 <div class="square bg-img" data-background="img/destination/greece1.jpg">  <span class="category"><a href="#0">Greece </a></span>
                                     <div class="square-container d-flex align-items-end justify-content-end">
                                         <div class="box-title">
                                             <h4>Zakynthos </h4>
                     ...
                     <div class="sidebar">
                         <div class="right-sidebar">
                             <div class="right-sidebar item">
                                 <h3><span class="right-sidebar">Plan Your Trip </span></h3>
                                     ...
                                     <div class="row">
                                         <div class="col-md-12 form-group select1_inner">
                                             <select class="select2 select">
                                                 ...
                                                 <option value="2" />Maldives
                                                 <option value="3" />Greece
                                                 <option value="3" />France
                                                 <option value="3" />Canada
                                             </select>
                                         </div>
                                         <div class="col-md-12 form-group">
                                             <input name="name" type="text" placeholder="Travel Type" />
                                         </div>
                                         <div class="col-md-12 form-group input1_inner">
                                             <input type="text" class="form-control input datepicker" placeholder="Start Date" required="" />
                                         </div>
                                         <div class="col-md-12 form-group input1_inner">
                                             <input type="text" class="form-control input datepicker" placeholder="End Date" required="" />
                                         </div>
                                         <div class="col-md-12">
                                             <button class="butn-dark"><a href="#0"><span>Search Now </span></a></button>
                                         </div>
                                     </div>
                                 </form>
                             </div>
