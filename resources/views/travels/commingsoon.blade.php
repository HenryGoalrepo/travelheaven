<!DOCTYPE html>
 <html lang="zxx">
 <head>
<!-- Original URL: https://duruthemes.com/demo/html/travol/multipage-slider/coming-soon.html
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <body><div style="z-index: 9999; position: fixed; width: 100%; border: 0px; padding: 5px; margin: 0px; background-color: transparent;  font-size: 12pt; font-family: sans-serif;" id="web2disk_nag" onclick="javascript: document.getElementById('web2disk_nag').style.display = 'none';">
                 ...
                 <ul class="navbar-nav ms-auto">
                     ...
                     <li class="nav-item dropdown">  <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Pages  <i class="ti-angle-down"></i></a>
                         <ul class="dropdown-menu">
                             ...
                             <li class="dropdown-submenu dropdown">  <a class="dropdown-item active dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" href="#"><span>Other Pages  <i class="ti-angle-right"></i></span></a>
                                 <ul class="dropdown-menu">
                                     <li><a href="coming-soon.html" class="dropdown-item active"><span>Coming Soon </span></a></li>
     ...
     <section class="comming section-padding">
         <div class="v-middle">
             <div class="container">
                 <div class="row text-center mb-20 mt-30">
                     <div class="col-md-12">
                         <h2>Coming Soon! </h2>
                     </div>
                 </div>
                 ...
                 <div class="row text-center">
                     <div class="offset-md-3 col-md-6">
                         <p>Sign up for our ______ blog & articles. </p>
                         <form>
