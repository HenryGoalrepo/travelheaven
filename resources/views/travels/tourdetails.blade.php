<!DOCTYPE html>
 <html lang="zxx">
 <head>
<!-- Original URL: https://duruthemes.com/demo/html/travol/multipage-slider/tour-details.html
Date Downloaded: 5/20/2023 9:54:50 AM !-->
 ...
 <body><div style="z-index: 9999; position: fixed; width: 100%; border: 0px; padding: 5px; margin: 0px; background-color: transparent;  font-size: 12pt; font-family: sans-serif;" id="web2disk_nag" onclick="javascript: document.getElementById('web2disk_nag').style.display = 'none';">
     ...
     <header class="header slider">
         <div class="owl-carousel owl-theme">
             ...
             <div class="text-center item bg-img" data-overlay-dark="2" data-background="img/slider/15.jpg"></div>
             <div class="text-center item bg-img" data-overlay-dark="2" data-background="img/slider/16.jpg"></div>
             <div class="text-center item bg-img" data-overlay-dark="2" data-background="img/slider/17.jpg"></div>
         </div>
         <!-- arrow down -->
             ...
             <div class="row">
                 <div class="col-md-8 mb-30">
                     ...
                     <div class="tour-page head-icon">
                         <p><i class="ti-time"></i> 5 Days 4 ______ </p>
                         <p><i class="ti-user"></i> Group: 5 - 10 People </p>
                         <p><i class="ti-location-pin"></i> Maldives </p>
                         <p><i class="ti-face-smile"></i> 9.3 Superb </p>
                     </div>
                     <h6>Information </h6>
                     <p class="mb-30">Travel non lorem ac ____ suscipit bibendum nulla facilisi. ________ nunc volutpat miss sapien ________ turpeutionyer masin libero sevenion ________ viventa augue sit amet _________ vestibulum. Duisterione venenatis lacus _______ eros ut turpis interdum ______. </p>
                     <ul class="list-unstyled page-list mb-30">
                         <li>
                             <div class="page-list-icon">  <span class="ti-check"></span>  </div>
                             <div class="page-list-text">
                                 <p>5 Days 4 Nights, _____: 5 - 10 People, ________ </p>
                             </div>
                         </li>
                     </ul>
                     <p class="mb-30">Interdum et malesu they _______ fames ac anteipsu pimsine ________ curabitur arcu site feugiat ____ volutpat sollicitudin libero. Hotel ___ lorem acer suscipit bibendum _____ facilisi nedeuter nunc vousa _____ sapien velet conseyer turpeutionyer _____ libero sempe molis. </p>
                     ...
                     <div class="tour-page time-table-price">  <span>Price Includes </span>
                         <ul class="tour-page time-table-price-include">
                             ...
                             <li><i class="ti-check"></i> Porter &amp; Personal _____ </li>
                     ...
                     <div class="tour-page time-table-price">  <span>Price Excludes </span>
                         <ul class="tour-page time-table-price-exclude">
                             ...
                             <li><i class="ti-close"></i> Sunscreen, toiletries and ________ items </li>
                         </ul>
                     </div>
                     <br />
                     <br />
                     ...
                     <div class="row">
                         <div class="col-md-4 gallery-item">
                             <a href="img/tours/maldives2.jpg" title="" class="img-zoom">
                                 <div class="gallery-box">
                                     <div class="gallery-img">  <img src="img/tours/maldives2.jpg" class="img-fluid mx-auto d-block" alt="work-img" />  </div>
                                 </div>
                             </a>
                         </div>
                         <div class="col-md-4 gallery-item">
                             <a href="img/tours/maldives3.jpg" title="" class="img-zoom">
                                 <div class="gallery-box">
                                     <div class="gallery-img">  <img src="img/tours/maldives3.jpg" class="img-fluid mx-auto d-block" alt="work-img" />  </div>
                                 </div>
                             </a>
                         </div>
                         <div class="col-md-4 gallery-item">
                             <a href="img/tours/maldives4.jpg" title="" class="img-zoom">
                                 <div class="gallery-box">
                                     <div class="gallery-img">  <img src="img/tours/maldives4.jpg" class="img-fluid mx-auto d-block" alt="work-img" />  </div>
                                 </div>
                             </a>
                         </div>
                     </div>
                     ...
                     <ul class="accordion-box clearfix">
                         <li class="accordion block">
                             ...
                             <div class="acc-content">
                                 <div class="content">
                                     <div class="text">Travel non lorem ac ____ suscipit bibendum nulla facilisi. ________ nunc volutpat miss sapien ___ conseyen turpeutionyer masin libero ________ vusetion viventa augue sit ____ hendrerit vestibulum. Duisteyerion venenatis _____ gravida eros ut turpis ________ ornare. </div>
                                 </div>
                             </div>
                         </li>
                         <li class="accordion block">
                     ...
                     <div class="sidebar">
                         <div class="right-sidebar">
                             <div class="right-sidebar item">
                                 <h3><span class="right-sidebar item__from">From </span><span class="right-sidebar item__sale">$1.250 </span>$900 </h3>
