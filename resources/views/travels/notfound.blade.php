<!DOCTYPE html>
 <html lang="zxx">
 <head>
<!-- Original URL: https://duruthemes.com/demo/html/travol/multipage-slider/404.html
             ...
             <div class="container">
                 ...
                 <div class="row text-center">
                     <div class="col-md-6 offset-md-3 text-center">
                         <p>The page you are _______ for was moved, removed, _______ or never existed. </p>
                         <form>
                             <input type="text" name="search" placeholder="Search" required="" />
                             <button><i class="ti-search"></i> Search </button>
                         </form>
                     </div>
                 </div>
                 <div class="row text-center">
